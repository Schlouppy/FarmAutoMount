...
local translations = {
    ...
    enGB = {
        ...
        ["Usage mount"] = "Usage: /fam mount <name> (shift+click possible)",
        ["Usage account"] = "Usage: /fam account <name> (shift+click possible)",
        ["Commands"] = "Commands:",
    ...
    frFR = {
        ...
        ["Usage mount"] = "Utilisation : /fam mount <nom> (shift+clic possible)",
        ["Usage account"] = "Utilisation : /fam account <nom> (shift+clic possible)",
        ["Commands"] = "Commandes :",
    ...
    deDE = {
        ...
        ["Usage mount"] = "Verwendung: /fam mount <Name> (Shift+Klick möglich)",
        ["Usage account"] = "Verwendung: /fam account <Name> (Shift+Klick möglich)",
        ["Commands"] = "Befehle:",
    ...
    esES = {
        ...
        ["Usage mount"] = "Uso: /fam mount <nombre> (shift+clic posible)",
        ["Usage account"] = "Uso: /fam account <nombre> (shift+clic posible)",
        ["Commands"] = "Comandos:",
    ...
    itIT = {
        ...
        ["Usage mount"] = "Uso: /fam mount <nome> (shift+clic possibile)",
        ["Usage account"] = "Uso: /fam account <nome> (shift+clic possibile)",
        ["Commands"] = "Comandi:",
    ...
    ptBR = {
        ...
        ["Usage delay"] = "Uso: /fam delay <segundos>",
        ["Usage mount"] = "Uso: /fam mount <nome> (shift+clique possível)",
        ["Usage account"] = "Uso: /fam account <nome> (shift+clique possível)",
        ["Commands"] = "Comandos:",
    ...
    ruRU = {
        ...
        ["Usage mount"] = "Использование: /fam mount <имя> (shift+клик возможен)",
        ["Usage account"] = "Использование: /fam account <имя> (shift+клик возможен)",
        ["Commands"] = "Команды:",
    ...
    koKR = {
        ...
        ["Usage mount"] = "사용법: /fam mount <이름> (shift+클릭 가능)",
        ["Usage account"] = "사용법: /fam account <이름> (shift+클릭 가능)",
        ["Commands"] = "명령어:",
    ...
    zhCN = {
        ...
        ["Usage mount"] = "用法: /fam mount <名称> (shift+点击可用)",
        ["Usage account"] = "用法: /fam account <名称> (shift+点击可用)",
        ["Commands"] = "命令:",
    ...
    zhTW = {
        ...
        ["Delay set to"] = "延遲設定為",
        ["Usage delay"] = "用法: /fam delay <秒>",
        ["Usage mount"] = "用法: /fam mount <名稱> (shift+點擊可用)",
        ["Usage account"] = "用法: /fam account <名稱> (shift+點擊可用)",
        ["Commands"] = "指令:",
